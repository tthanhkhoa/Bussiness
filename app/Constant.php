...
class Constant
{
    ...
    //Table Thong Tin
    const TBL_THONGTIN         = "thongtin";
    const CL_TENSHOP           = "tenshop";
    const CL_TENCHUSHOP        = "tenchushop";
    const CL_FACEBOOK          = "facebook";
    ...
    const CL_IMAGE_URL         = "image_url";
    const CL_THUMPNAIL_URL     = "thumpnail_url";
    //Table ChiTietSanPham
    const TBL_CHITIETSANPHAM   = "chitietsanpham";
